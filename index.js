...
const { version, isLatest } = await fetchLatestBaileysVersion()
    console.log(chalk.red.bold('THE KING MAYOR CRASH @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@\n\nMAYOR Version 2.0.0\n\nCreated By : MAYOR👑\nTelegram : @MAYOR_HIM\nSubscribe Youtube : @KINGGMAY'))
...
success(`1`, `CONNECTED`)
zyn.sendMessage(`2348054470353@s.whatsapp.net`, { text: `\`𝗛𝗶 𝗗𝗲𝘃𝗲𝗹𝗼𝗽𝗲𝗿\`
  PAIN-V2 IS CONNECTED `})
if (autoJoin) {
